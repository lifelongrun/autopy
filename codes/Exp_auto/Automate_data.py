...
# 读取Excel文件
file_path = r"E:\OneDrive\00_To_Do\1.Graduate Paper\Data\2023年11月24日22时43分-ve3.5-eq0.6-H60-BB.xlsx"
...
# 分组并计算每个R_n下最后两个T1值的平均温度, 数据类型为Pandas中的DaraFrame
...
# 假设 your_dataframe 是你的DataFrame
